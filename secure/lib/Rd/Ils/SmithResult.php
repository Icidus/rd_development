...
class Rd_Smith_Result extends AbstractResult
{    	
			   ...
			   switch ($field['id'])
			   {
					...
					case '020':	// ISBN
						foreach($field->subfield as $subfield) {
							if((string)$subfield['label']=='a') {	//isbn = subfield type "a"
					...
					case '035':
						...
						foreach($field->subfield as $subfield) {
							if((string)$subfield['label']=='a') {	//OCLC # = subfield type "a"
			   		...
			   		case '245': //Title
			   			...
			   			foreach ($field->subfield as $key=>$subfield)
			   			{
