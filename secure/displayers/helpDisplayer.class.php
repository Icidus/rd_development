...
require_once(APPLICATION_PATH . '/classes/help.class.php');

class helpDisplayer extends Rd_Displayer_Base {
...
?>
		<p />
		<a class="sidebarLink" href="#" onclick="javascript:help('cmd=help'); return false;">Launch Help in Sidebar</a>
<?php
	}
	 ...
	 */
	public static function displaySearchForm($hidden_fields=null) {
...
<?php
	 ...
	 */
	public static function displayBrowseForm($hidden_fields=null) {
...
<?php
	 ...
	 */
	public static function displaySearchResults($articles, $query, $next_cmd) {
		self::displaySearchForm();
	 ...
	 * @desc Displays list of articles
	 */
	public static function displayArticleList($articles, $show_tags=false, $preview_content=false, $query=null, $next_cmd=null) {
...
<?php
	 ...
	 */
	public static function displayArticle($article, $query=null) {
		$u = Account_Rd::getUserInterface();
...
<?php	
	 ...
	 */
	public static function displayTags($article_id, $tags, $user_tags, $allow_edit=false) {
?>
	<script type="text/javascript" language="JavaScript1.2" src="public/javascript/basicAJAX.js"></script>
	<script type="text/javascript" language="JavaScript1.2" src="public/javascript/help_ajax.js"></script>	
...
<?php
	...
	public static function displayTagsEditFormAJAX($article_id, $user_tags) {
		$u = Account_Rd::getUserInterface();
?>
...
<?php
	 ...
	 */
	public static function formatTagsOutput($tags, $user_tags, $format_as_list=false) {
	 ...
	 */
	public static function displayArticleForm($article=null) {
		global $g_permission;
		$u = Account_Rd::getUserInterface();
...
<?php	
		foreach($g_permission as $perm_label=>$perm):
			if($perm > Account_Rd::LEVEL_FACULTY || $perm < Account_Rd::LEVEL_STUDENT) {	//do not go above instructor
				continue;
			}
?>
...
<?php
	 ...
	 */
	public static function displayCategoryForm($category=null) {
		global $g_permission;
...
<?php
	 ...
	 */
	public static function displayTagInput($tags) {
...
<?php
	 ...
	 */
	public static function displayCategorySelect($default_category_id=null) {
...
<?php
	 ...
	 */
	public static function displayCategory($category, $articles, $next_cmd=null) {
?>
...
<?php
	 ...
	 * @desc Displays articles in the specified category
	 */
	public static function displayTagArticles($tag, $articles) {
		$u = Account_Rd::getUserInterface();
...
<?php
	 ...
	 */
	public static function displayRelatedTags($origin_tag, $related_tags, $format_as_list=false) {
	 ...
	 */
	public static function displayHelpError($text) {
	 ...
	 */
	public static function displayFindRelated($msg=null, $article1_id=null, $rel_op=null, $relationship=null) {
	 ...
	 */
	protected static function highlightTerms($text, $query) {
