...
INSERT INTO mimetypes (mimetype_id, mimetype, helper_app_url, helper_app_name, helper_app_icon) VALUES (1, 'application/pdf', 'http://www.adobe.com/products/acrobat/readstep2.html', 'Adobe Acrobat Reader', 'public/images/doc_type_icons/doctype-pdf.gif');
//#STATEMENT
INSERT INTO mimetypes (mimetype_id, mimetype, helper_app_url, helper_app_name, helper_app_icon) VALUES (2, 'audio/x-pn-realaudio', 'http://www.real.com/', 'RealPlayer', 'public/images/doc_type_icons/doctype-sound.gif');
//#STATEMENT
INSERT INTO mimetypes (mimetype_id, mimetype, helper_app_url, helper_app_name, helper_app_icon) VALUES (3, 'video/quicktime', 'http://www.apple.com/quicktime/', 'Quicktime Player', 'public/images/doc_type_icons/doctype-movie.gif');
//#STATEMENT
INSERT INTO mimetypes (mimetype_id, mimetype, helper_app_url, helper_app_name, helper_app_icon) VALUES (4, 'application/msword', 'http://office.microsoft.com/Assistance/9798/viewerscvt.aspx', 'Microsoft Word', 'public/images/doc_type_icons/doctype-text.gif');
//#STATEMENT
INSERT INTO mimetypes (mimetype_id, mimetype, helper_app_url, helper_app_name, helper_app_icon) VALUES (5, 'application/vnd.ms-excel', 'http://office.microsoft.com/Assistance/9798/viewerscvt.aspx', 'Microsoft Excel', 'public/images/doc_type_icons/doctype-text.gif');
//#STATEMENT
INSERT INTO mimetypes (mimetype_id, mimetype, helper_app_url, helper_app_name, helper_app_icon) VALUES (6, 'application/vnd.ms-powerpoint', 'http://office.microsoft.com/Assistance/9798/viewerscvt.aspx', 'Microsoft Powerpoint', 'public/images/doc_type_icons/doctype-text.gif');
//#STATEMENT
INSERT INTO mimetypes (mimetype_id, mimetype, helper_app_url, helper_app_name, helper_app_icon) VALUES (7, 'text/html', NULL, 'Link', 'public/images/doc_type_icons/doctype-link.gif');
...
INSERT INTO `reports` VALUES  
  (1,'Electronic Items Added By Role','term',
    ...
    'term_id',4,0,0,0),
  (2,'Totals: Items And Reserves','term',
  ...
  (4,'Totals: Users',NULL,
    ...
    NULL,4,0,1,6),
  (6,'Global: Courses And Users','term_lib',
    ...
    'term_id,library_id',4,1,1,6),
  (7,'Global: Items And Reserves','term_lib',
    ...
    'term_id,library_id',4,1,1,6),
  (8,'Global: Upload Activity','term_dates_usertype',
    ...
    'begin_date,end_date,permission_id',4,0,0,0),
  (9,'Item View Log for a class by date','class',
    ...
    'ci',4,2,0,0),
  (10,'Courses With Active Reserves','term',
  ...
  (11,'New Items','term_dates',
    ...
    'begin_date,end_date',4,0,0,0),
  (12,'Re-activated Items','term_dates',
    'SELECT \n  IF(c.uniform_title IS NOT NULL AND c.uniform_title <> \'\',\n    CONCAT(d.abbreviation, \' \', c.course_number, \' - \',  c.uniform_title),\n    CONCAT(d.abbreviation, \' \', c.course_number, \' - \',  ca.course_name)\n  ) AS \'Course\', \n  ci.status AS \'Course Status\', \n  CONCAT(i.item_group, \' (\', me.file_extension, \')\') AS \'Item Type\', \n  i.title AS \'Document Title\', \n  i.volume_title AS \'Work Title\', \n  i.ISBN, \n  i.OCLC, \n  i.ISSN, \n  i.pages_times AS \'Pages/Times\', \n  pl.label AS \'Added By\', \n  i.creation_date AS \'Date Created\', \n  IF (i.private_user_id IS NOT NULL,\n    CONCAT(u.first_name, \' \', u.last_name),\n    \'n/a\'\n  ) AS \'Private Owner\', \n  r.reserve_id AS \'Reserve ID\', \n  i.item_id AS \'Item ID\' \n  FROM items AS i \n  JOIN reserves AS r ON r.item_id = i.item_id \n  JOIN course_instances AS ci ON ci.course_instance_id = r.course_instance_id \n  JOIN course_aliases AS ca ON ca.course_alias_id = ci.primary_course_alias_id \n  JOIN courses AS c ON c.course_id = ca.course_id \n  JOIN departments AS d ON d.department_id = c.department_id \n  LEFT JOIN mimetypes AS m ON m.mimetype_id = i.mimetype \n  LEFT JOIN (\n    SELECT mimetype_id, GROUP_CONCAT(file_extension SEPARATOR \', \') AS file_extension\n    FROM mimetype_extensions mecon\n    WHERE \'\' <> file_extension\n    GROUP BY mimetype_id\n  )AS me ON me.mimetype_id = m.mimetype_id\n  LEFT JOIN users AS u ON u.user_id = i.private_user_id \n  LEFT JOIN electronic_item_audit AS eia ON eia.item_id = i.item_id \n  LEFT JOIN users AS u2 ON u2.user_id = eia.added_by \n  LEFT JOIN permissions_levels AS pl ON pl.permission_id = u2.dflt_permission_level \n  WHERE r.activation_date BETWEEN ? AND ? \n    AND r.reserve_id <> ( \n      SELECT MIN(r2.reserve_id) \n      FROM reserves AS r2 \n      WHERE r2.item_id = r.item_id\n    )\n  ORDER BY Course ASC',
    'begin_date,end_date',4,0,0,0),
  (13,'Item View Log','class',
  ...
  (17,'Classes Needing Review','term',
    ...
    'term_id',4,17,1,6),
  (19,'Totals: Items and Reserves by Term & Library','term_lib',
...
INSERT INTO `skins` 
  (`id`, `skin_name`, `skin_stylesheet`, `default_selected`) 
  VALUES (1, 'general', 'ReservesStyles.css', 'yes');
...
INSERT INTO users
  (user_id, username, first_name, last_name, email, dflt_permission_level) 
  VALUES (1, 'admin', 'Admin', 'Admin', 'noreply@changethis.com', 5);

//#STATEMENT
  
INSERT INTO special_users
  (user_id, password, expiration) 
  VALUES (1, 'd8578edf8458ce06fbc5bb76a58c5ca4', NULL); -- password is 'qwerty'