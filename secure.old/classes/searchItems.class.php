...
//print_r(array($term, $value, $f=0, $e=20)); die;		
		...
		if (false && isset($_SESSION) && array_key_exists('debug', $_SESSION) && $_SESSION['debug']) 
		{
	...
	*/
	function displaySearchScreen($page, $subpage, $courseInstance=null)
	{
        ...
        echo "										You may also search the library's collection in <a href=\"{$catalogURL}\">{$g_catalogName}</a>.\n";
        echo "									</td>\n";
        echo "								</tr>\n";
        echo "							</table>\n";
        echo "						</td>\n";
