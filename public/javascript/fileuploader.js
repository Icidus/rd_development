...
qq.FileUploaderBasic = function(o){
    ...
    this.disable = function() {
    	var input = jQuery(this._button._input);
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button"><span class="buttonText">Upload a file</span></div>' +
...
qq.UploadButton.prototype = {
    ...
    reset: function(){
    	var originalDisabled = this._input.disabled;
    	var originalCursor = jQuery(this._input).css('cursor');
        ...
        this._input = this._createInput();
        this._input.disabled = originalDisabled;
        jQuery(this._input).css('cursor', originalCursor);
    },    
